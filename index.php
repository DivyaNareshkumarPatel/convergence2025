...
<body>
  ...
  <header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        ...
        <a href="index.php" class="scrollto"><img src="assets/img/mainLogo.png" alt="" title=""></a>
      </div>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#mega_events">Events</a></li>
          <li><a class="nav-link scrollto" href="#hotels">Accomodation</a></li>
          ...
          if (isset($_COOKIE['login_user'])) {
            ?>
            <li class="buy-tickets scrollto dropdown me-5"><a href="#"><span>Hi, <?php echo $name; ?></span> <i
                  class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="profile.php">Email - <?php echo $email; ?></a></li>
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="hero-content" data-aos="zoom-in" data-aos-delay="100">
        <h1 class="mb-4 pb-0 heading">2025<br> Convergence<br></h1>
        <p>WHEN IMAGINATION MEETS INNOVATION</p>
        <p class="mb-4 pb-0">Ganpat University, Gujarat.</p>
        <div class="btns">
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Convergence 2022 is one of the most awaited events of the year, making campus vibrant, full of energy,
              excitement, and youthfulness. It is the combination of nine wings, namely - Infocrats, CIVESTA,
              Mech-Mechato,
              PetroX, Biotechnica, Electabuzz, MARITECH, MATHMAGIX, General Events. The Nine Wings encourages students
              from various
              field such as Technology, Computer Engineering, IT, Civil, Electrical Engineering and many more to
              showcase and test their skillset on a national platform.</p>
          </div>
          <div class="col-lg-3">
            <h3>Where</h3>
    ...
    <!-- ======= mega_events Section ======= -->
    <section id="mega_events">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2>Convergence Mega Events</h2>
        ...
        <div class="row">
          ...
          if(mysqli_num_rows($result) == 0) {
            ?>
              <p style="text-align: center;">No departments are available</p>
            <?php
          }
          else {
            while ($rows = $result->fetch_assoc()) {
              ...
              <div class="col-lg-4 col-md-6">
                <a href="events.php?department=<?php echo $rows['department_name'] ?>">
                  <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                    <img src=<?php echo $rows['department_icon_path'] ?> alt="Department" class="img-fluid">
                    <div class="details">
                      <h3><a href="events.php?department=<?php echo $rows['department_name'] ?>">
                          <?php echo $rows['department_name'] ?>
                        </a></h3>
                      <div class="social">
                        <a href="events.php?department=<?php echo $rows['department_name'] ?>">View Events</a>
                      </div>
                    </div>
                  </div>
                </a>
    ...
    <section id="gallery">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2>Gallery</h2>
          <p>Check out some glimps of 2022 Blockbuster</p>
        </div>
      </div>
        ...
        <div class="row no-gutters supporters-wrap clearfix" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="assets/img/supporters/SSIP_LOGo.png" class="img-fluid" alt="">
            </div>
          </div>
        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-9">
            ...
            <ul class="faq-list">
              ...
              <li>
                <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">Are deposits refundable? <i
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">What kind of events do you offer?
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">What if there is an emergency?
                  Can we change the date or details without additional fees? <i
                    class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Do you have a caterer or
                  photographer reference or partnership?<i class="bi bi-chevron-down icon-show"></i><i
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq5" class="collapsed question">Do you charge separately for your
                  various event services? <i class="bi bi-chevron-down icon-show"></i><i
                    class="bi bi-chevron-up icon-close"></i></div>
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">Can i get food for free? <i
                    class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
    ...
    <section id="subscribe">
      <div class="container" data-aos="zoom-in">
        <div class="section-header">
          <h2>Stay Updated</h2>
          <p>Subscribe to Convergence | We keep you updated.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>Convergence 2022 is one of the most awaited events of the year, making campus vibrant,
              full of energy, excitement, and youthfulness. It is the combination of nine wings, namely - Infocrats,
              CIVESTA,
              Mech-Mechato, PetroX, Biotechnica, Electabuzz, MARITECH, MATHMAGIX, General Events. The Nine Wings
              encourages
              students from various field such as Technology, Computer
              Engineering, IT, Civil, Electrical Engineering and many more to showcase and test their skillset on a
              national platform.</p>
          </div>
